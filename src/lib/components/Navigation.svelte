...
<nav class="bg-white shadow sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <a href="/" class="flex items-center space-x-2">
            ...
            <span class="text-2xl font-bold">Theta Scraper</span>
        </a>
  
      <!-- Desktop Menu -->
      <ul class="hidden md:flex space-x-6 items-center">
        <li><a href="/" class="text-gray-700 hover:text-gray-900 transition-colors">Home</a></li>
        <li><a href="/trading" class="text-gray-700 hover:text-gray-900 transition-colors font-semibold">📈 Trading</a></li>
        <li>
          <button
